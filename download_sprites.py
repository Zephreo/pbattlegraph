...
Downloads sprites from PokemonDB for all Pokemon
"""
...
# Pokemon data - names mapped to their national dex numbers
POKEMON = [
    ...
    (806, "Blacephalon"), (807, "Zeraora"), (808, "Meltan"), (809, "Melmetal"), (810, "Grookey"),
    (811, "Thwackey"), (812, "Rillaboom"), (813, "Scorbunny"), (814, "Raboot"), (815, "Cinderace"),
    (816, "Sobble"), (817, "Drizzile"), (818, "Inteleon"), (819, "Skwovet"), (820, "Greedent"),
    (821, "Rookidee"), (822, "Corvisquire"), (823, "Corviknight"), (824, "Blipbug"), (825, "Dottler"),
    (826, "Orbeetle"), (827, "Nickit"), (828, "Thievul"), (829, "Gossifleur"), (830, "Eldegoss"),
    ...
    (856, "Hatenna"), (857, "Hattrem"), (858, "Hatterene"), (859, "Impidimp"), (860, "Morgrem"),
    (861, "Grimmsnarl"), (862, "Obstagoon"), (863, "Perrserker"), (864, "Cursola"), (865, "Sirfetch'd"),
    ...
    (876, "Indeedee"), (877, "Morpeko"), (878, "Cufant"), (879, "Copperajah"), (880, "Dracozolt"),
    (881, "Arctozolt"), (882, "Dracovish"), (883, "Arctovish"), (884, "Duraludon"), (885, "Dreepy"),
    (886, "Drakloak"), (887, "Dragapult"), (888, "Zacian"), (889, "Zamazenta"), (890, "Eternatus"),
    (891, "Kubfu"), (892, "Urshifu"), (893, "Zarude"), (894, "Regieleki"), (895, "Regidrago"),
    (896, "Glastrier"), (897, "Spectrier"), (898, "Calyrex"), (899, "Wyrdeer"), (900, "Kleavor"),
    (901, "Ursaluna"), (902, "Basculegion"), (903, "Sneasler"), (904, "Overqwil"), (905, "Enamorus"),
    ...
    (1004, "Chi-Yu"), (1005, "Roaring Moon"), (1006, "Iron Valiant"), (1007, "Koraidon"),
    (1008, "Miraidon"), (1009, "Walking Wake"), (1010, "Iron Leaves"), (1011, "Dipplin"),
    (1012, "Poltchageist"), (1013, "Sinistcha"), (1014, "Okidogi"), (1015, "Munkidori"),
    (1016, "Fezandipiti"), (1017, "Ogerpon"), (1018, "Archaludon"), (1019, "Hydrapple"),
    (1020, "Gouging Fire"), (1021, "Raging Bolt"), (1022, "Iron Boulder"), (1023, "Iron Crown"),
    (1024, "Terapagos"), (1025, "Pecharunt")
]

def name_to_slug(name):
    """Convert Pokemon name to URL-friendly slug for PokemonDB"""
    slug = name.lower()
...
def download_sprite(pokemon_id, name, retries=3):
    """Download a single Pokemon sprite"""
    slug = name_to_slug(name)
    
    # PokemonDB sprite URL - using home sprites (3D renders)
    url = f"https://img.pokemondb.net/sprites/home/normal/{slug}.png"
    
    # Filename with ID prefix for proper sorting
    filename = f"{pokemon_id:04d}_{slug}.png"
    ...
    for attempt in range(retries):
        try:
            ...
            if attempt < retries - 1:
                ...
                return False, f"Failed: {name} ({pokemon_id}) - {e}"
    
    return False, f"Failed after {retries} attempts: {name}"

def main():
    print(f"Pokemon Sprite Downloader")
    print(f"Downloading {len(POKEMON)} sprites to: {SPRITES_DIR}")
    print("-" * 60)
    ...
    for i, (pokemon_id, name) in enumerate(POKEMON, 1):
        success, message = download_sprite(pokemon_id, name)
        ...
        if success:
            ...
            fail_count += 1
            failed_pokemon.append((pokemon_id, name))
            status = "✗"
        
        # Progress display
        print(f"[{i:4d}/{len(POKEMON)}] {status} {message}")
    ...
    print("-" * 60)
    print(f"Complete! Downloaded: {success_count}, Failed: {fail_count}")
    
    if failed_pokemon:
        print("\nFailed downloads:")
        for pid, pname in failed_pokemon:
            print(f"  - {pid}: {pname}")
